...
class RequestWrapperCombiner8<A, B, C, D, E, F, G, H, I> extends RequestWrapper<I>{
  ...
  RequestWrapperCombiner8.combine(RequestWrapper<A> a,
      RequestWrapper<B> b,
      RequestWrapper<C> c,
      RequestWrapper<D> d,
      RequestWrapper<E> e,
    ...
    void _listen(){
      ...
      _notify(a.result, b.result, c.result, d.result, e.result, f.result, g.result, h.result);
    }
